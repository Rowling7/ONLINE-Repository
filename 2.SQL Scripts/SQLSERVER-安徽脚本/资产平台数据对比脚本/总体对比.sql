...
isnull(left(k001.k0155,4),'0')<>isnull(left(zcpt_k001.k0155,4),'0') or-- 最后一次大中修年度,
rtrim(k001.hK0182)<>rtrim(zcpt_k001.hK0182)	or -- 断链类型,
rtrim(k001.HK0123)<>rtrim(zcpt_k001.HK0123)	or -- 是否断头,
rtrim(k001.HK0136)<>rtrim(zcpt_k001.HK0136)	or -- 路段收费性质,
rtrim(k001.HK0121)<>rtrim(zcpt_k001.HK0121)	or -- 是否城管,
rtrim(k001.HK0156)<>rtrim(zcpt_k001.HK0156)	or -- 省际出入口,
